...
async function getList() {
    ...
    resObject.links.forEach(element => {
        HTML+= `<div>
                <p>Path: </p><a href="${`${resObject.url}/${resObject.prefix}/${element.path}`}" target="_blank">${element.path}</a>
                <p>Destination: </p><a href="${element.destination}" target="_blank">${element.destination}</a>
